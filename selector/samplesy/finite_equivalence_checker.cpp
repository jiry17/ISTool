...
FiniteEquivalenceChecker::FiniteEquivalenceChecker(DifferentProgramGenerator* _g, FiniteIOExampleSpace* io_space): g(_g) {
...
void FiniteEquivalenceChecker::addExample(const IOExample &example) {
    g->addExample(example);
}

ProgramList FiniteEquivalenceChecker::getTwoDifferentPrograms() {
    ProgramList res;
